...
├─ scripts/             # служебные сценарии загрузки и подготовки данных
...
- наличием тематических учебных наборов данных в `data/sample/`;
- возможностью восстановить полные исходные данные через `scripts/fetch_open_datasets.py`;
